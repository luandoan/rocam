...
int main( int argc, char **argv )
{
  ...
  // Open camera with CAMERA_INDEX (webcam is typically #0).
    //const std::string videoStreamAddress = "http://192.168.1.80:81/videostream.cgi?loginuse=admin&amp;loginpas=12345&.mjpg";
    const std::string videoStreamAddress = "http://192.168.1.76:81/videostream.cgi?loginuse=admin&amp;loginpas=12345&.mjpg";
